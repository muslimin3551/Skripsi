...
<div class="page-heading">
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Siswa Menu</h3>
                <p class="text-subtitle text-muted">Tambah Data Siswa </p>
            </div>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                <p>Masukan Data sesuai dengan dengan identitas siswa!</p>
                    ...
                    <div class="row">
                        <div class="col-md-6">
                            <div class="form-group">
                                ...
                                <input type="text" name="nis" class="form-control" placeholder="NISN" required>
                            </div>
                            <div class="form-group">
