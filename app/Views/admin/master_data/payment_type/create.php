    ...
    <div class="page-title">
        <div class="row">
            <div class="col-12 col-md-6 order-md-1 order-last">
                <h3>Menu Kelas</h3>
                <p class="text-subtitle text-muted">Tambah Data Jenis Pembayaran </p>
            </div>
    ...
    <section class="section">
        <div class="card">
            ...
            <div class="card-body">
                ...
                <?php endif; ?>
                <form action="<?= base_url('admin/payment_type/add') ?>" method="post">
                    <div class="row">
                        <div class="col-md-12">
                            <div class="form-group">
                                <label for="title">Jenis Pembayaran</label>
                                <input type="text" name="title" class="form-control" placeholder="Jenis Pembayaran" required>
                            </div>
                            <div class="form-group">
